...
# Configuration
ROOT_DIR = r"D:\new researches\Car research2\dataset\DB1__segmented_audio"  # Root directory
OUTPUT_FEATURES_CSV = os.path.join(ROOT_DIR, "DB1_Categorized_features1.csv")  # Path for saving extracted features
